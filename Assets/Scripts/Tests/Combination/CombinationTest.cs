...
namespace Tests.Combination
{
    ...
    public class CombinationTest
    {
        ...
        public void TestConstructor()
        {
            ...
            Combination combination = new Pair(cards, 14);
        ...
        public void TestAceBeatsKing()
        {
            ...
            Combination aceSingle = new Single(new List<Card> { ace }, 14);
            Combination kingSingle = new Single(new List<Card> { king }, 13);
        ...
        public void TestDragonBeatsAce()
        {
            ...
            Combination aceSingle = new Single(new List<Card> { ace }, 14);
            Combination dragonSingle = new Single(new List<Card> { dragon }, 15);
        ...
        {
            Combination pair = new Pair(new List<Card> (), 14);
            Combination single = new Single(new List<Card> (), 13);
        ...
        {
            Combination highBomb = new StraightFlush(new List<Card> (), 14);
            Combination lowBomb = new StraightFlush(new List<Card> (), 13);
        ...
        public void TestFiveStraightBeatsSixStraight()
        {
            ...
            Combination fiveStraight = new Straight(fiveStraightCards, 14);
            Combination sixStraight = new Straight(sixStraightCards, 13);
